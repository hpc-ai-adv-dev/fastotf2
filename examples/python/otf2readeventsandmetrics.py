...
# archive_name = "/workspace/sample-traces/frontier-hpl-run-using-2-ranks-with-craypm/traces.otf2"
archive_name = "/workspace/sample-traces/simple-mi300-example-run/traces.otf2"
