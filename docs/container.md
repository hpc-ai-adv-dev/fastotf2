# Container Documentation Note

The primary user-facing container guide lives in [../container/README.md](../container/README.md).

That document is the supported end-to-end walkthrough for:
